...
//package:meloplay/presentation/utils/app_router.dart';
...
class FavSongListTile extends StatefulWidget {
  ...
  @override
  State<FavSongListTile> createState() => _SongListTileState();
}

class _SongListTileState extends State<FavSongListTile> {
  @override
              ...
              return Wrap(
                children: [
                  ListTile(
                    ...
                    title: Text('Remove from Favourite'),
                    onTap: () {
                      final songbloc = context.read<SongBloc>();
                      songbloc.add(RemoveFromFav(widget.song));
